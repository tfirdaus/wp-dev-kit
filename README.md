...
Inspired from [WP Dev Lib](https://github.com/xwp/wp-dev-lib) by [XWP](https://github.com/xwp), **WP Dev Kit** puts together a set of tools, common codes, and some opinitiated development configurations used in WordPress development.
